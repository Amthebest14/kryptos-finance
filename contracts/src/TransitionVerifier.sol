...
/// circuits/build/README.md) rather than a single-party one. Regenerated to
/// fix a real bug: the circuit previously demanded interestAccrued divide
/// out of debt*indexDelta/checkpointIndex exactly, which real interest
/// essentially never does — see transition.circom's own comment.
